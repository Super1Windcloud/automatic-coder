...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    println!("Plain activation codes  : {}", artefacts.plaintext_codes_path.display());
    println!("Encrypted store (server): {}", artefacts.encrypted_store_path.display());
    println!("Encrypted codes (client): {}", artefacts.encrypted_codes_path.display());
    Ok(())
}
